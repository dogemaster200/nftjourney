...
async function main() {
  ...
  async function makePath(_obj) {
    ...
    document.getElementById("demo").innerHTML = fullPath;
    document.body.innerHTML = document.body.innerHTML.replace(new RegExp(soldBefore, "g"), soldAfter);
    document.body.innerHTML = document.body.innerHTML.replace(new RegExp(sentBefore, "g"), sentAfter);
    document.body.innerHTML = document.body.innerHTML.replace(new RegExp(hBefore, "g"), hAfter);

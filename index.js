...
console.log(tokenInfo)
  ...
  makePath(obj);
  if (await tokenInfo.name == undefined){
    
     
    document.getElementById("header").innerHTML = "Enter a Valid Token ID and Serial Number";
    document.getElementById("nft").src = "./nope.jpg";
